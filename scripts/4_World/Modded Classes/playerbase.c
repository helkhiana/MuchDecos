modded class PlayerBase extends ManBase
{
    override void Init()
    {
        if ( GetGame().IsServer() || GetGame().IsMultiplayer() ) 
		{
            ...
            GetDayZPlayerType().AddItemInHandsProfileIK("MD_Kit", "dz/anims/workspaces/player/player_main/player_main_heavy.asi", heavyItemBehaviour, "dz/anims/anm/player/ik/heavy/wooden_crate.anm");
